...
@Component({
  selector: "app-keystone-faq",
  imports: [SectionComponent],
  templateUrl: "keystone-faq.html",
})
export class KeystoneFaq {
  ...
  /**
   * Toggle the expand/collapse state of a FAQ entry.
   *
   * @param index The index of the rendered FAQ entry.
   */
